...
class EarlyStopping:
    def __init__(self, patience=7, verbose=False, delta=0):
        ...
        loss_path = 'EfficientNet_best_loss.json'
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        torch.save(model.state_dict(), 'EfficientNet_best_checkpoint.pt')
        # 保存loss记录
        loss_path = 'EfficientNet_best_loss.json'
        print("[INFO]更新loss记录")
...
def main():
    ...
    with open('EfficientNet_class_to_idx.json', 'w') as f:
    ...
    # 检查是否有已保存的模型
    model_path = 'EfficientNet_best_checkpoint.pt'
